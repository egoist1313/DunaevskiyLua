...
local config_path = getGameDirectory() .. '/moonloader/LuaDunaevskiy/config/VoskChat.json'
local exe_path = getWorkingDirectory() .. '\\LuaDunaevskiy\\VoskBladwin'
...
local function saveSettings(data)
    if not json then
        logError("Бbibотека json не загружена")
        return false
    end
